...
import { Plus, FolderPlus, Layers, Search, Filter, AlertCircle } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between bg-white p-4 rounded-2xl border border-gray-200/80 shadow-2xs gap-3">
        <div>
          <h2 className="text-base font-bold text-gray-900 flex items-center gap-2">
            ...
            Milestone Hierarchy (Time & Action Tree)
          </h2>
        ...
        <button
          ...
          className="px-3.5 py-2 text-xs font-semibold text-white bg-teal-600 hover:bg-teal-700 rounded-xl shadow-xs transition-colors flex items-center gap-1.5 shrink-0"
        >
          <Plus className="w-4 h-4" />
          <span>Add Project / Department</span>
        </button>
      </div>
      ...
      <div className="bg-white p-3 rounded-2xl border border-gray-200 shadow-2xs flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
        <div className="relative w-full sm:w-80">
          <input
            ...
            placeholder="Search subtasks, vendors, assignees, months (e.g. October)..."
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="px-2.5 py-1.5 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-teal-500"
            >
